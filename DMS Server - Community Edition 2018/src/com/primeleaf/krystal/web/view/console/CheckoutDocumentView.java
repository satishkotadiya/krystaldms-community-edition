...
public class CheckoutDocumentView extends WebView {
	...
	private void deleteDocumentResponse() throws Exception{
		try {
			...
			out.println("<div class=\"panel-heading\"><h4><i class=\"fa fa-lg fa-lock text-danger\"></i> Checkout</h4></div>");
			out.println("<div class=\"panel-body\">");
			if(request.getAttribute(HTTPConstants.REQUEST_MESSAGE) != null){
				out.println("<h5><i class=\"fa fa-lg fa-check-circle text-success\"></i> "+request.getAttribute(HTTPConstants.REQUEST_MESSAGE) +"</h5>");
			...
			if(request.getAttribute(HTTPConstants.REQUEST_ERROR) != null){
				out.println("<h5><i class=\"fa fa-lg fa-times-circle text-danger\"></i> "+request.getAttribute(HTTPConstants.REQUEST_ERROR) +"</h5>");
			}
